    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Container(height: 60, child: Image.asset('assets/bel.png')),
        ],
      ),
    );
  }
        ...
        child: Card(
          ...
          child: Row(
            ...
            children: [
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      width: 30,
                      decoration: BoxDecoration(
                          color: task.isComplateTask == false
                              ? Colors.white
                              : Colors.green,
                      ...
                      child: task.isComplateTask == false
                          ? Icon(
                        Icons.done,
                        color: Colors.grey,
                      )
              ...
              GestureDetector(
                onTap: () {
                  BlocProvider.of<TaskCubit>(context).TurnOffNotification(task: task).then((value){
                    Future.delayed(Duration(seconds: 1),(){
                      BlocProvider.of<TaskCubit>(context).getAllTask();
                    });
                  });
