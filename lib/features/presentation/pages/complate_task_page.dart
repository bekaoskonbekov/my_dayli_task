...
class ComplateTaskPage extends StatefulWidget {
  const ComplateTaskPage({Key? key}) : super(key: key);

  @override
  _CompleteTaskPageState createState() => _CompleteTaskPageState();
}

class _CompleteTaskPageState extends State<ComplateTaskPage> {
      ...
      body: BlocBuilder<TaskCubit,TaskState>(
        builder: (context,taskState){
          if (taskState is TaskLoadedState){
           final completeTasks= taskState.taskData!.where((element) => element.isComplateTask==true).toList();
            return Column(
              children: [
